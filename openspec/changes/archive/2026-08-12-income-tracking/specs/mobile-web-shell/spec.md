...
#### Scenario: Navigate to Income when tracking on
- **WHEN** an authenticated Owner with **Income tracking** enabled follows the **Income** navigation control
- **THEN** they reach the Income tab view

#### Scenario: Income nav absent when tracking off
- **WHEN** an authenticated Owner with **Income tracking** disabled opens Today
- **THEN** primary navigation does not include an **Income** control
