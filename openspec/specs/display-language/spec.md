# display-language Specification

## Purpose

Define Owner-scoped **Display language** (`en` / `my`): locale resolution, persistence, guest cookie bridging, EN | MY toggles, Burmese translations and typography, and localized Gregorian day labels in Asia/Yangon.
## Requirements
