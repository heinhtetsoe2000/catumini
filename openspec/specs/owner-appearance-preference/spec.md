...
Define Owner-scoped **Appearance** (`light`, `dark`, `system`): persistence, guest cookie bridging, Profile-only Light | Dark | System toggle, and Flux-driven ledger ink theme override.
