...
Track Owner expenses (create, edit, delete) with integer **Ks** amounts, spend dates in `Asia/Yangon`, Today and Monthly views grouped by spend day, and localized day group headers following **Display language**.
